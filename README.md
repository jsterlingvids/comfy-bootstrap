...
- The MCP Panel is not mutable shared state. Bootstrap preserves and pins `comfyui-mcp-panel` at the reviewed direct-Hermes release `a3e75aa` and disables Panel backend autospawn.
