...
- The MCP Panel is not mutable shared state. Bootstrap preserves and pins `comfyui-mcp-panel` at the reviewed direct-Hermes release `238cc03` and disables Panel backend autospawn.
