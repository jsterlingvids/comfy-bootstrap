...
- The MCP Panel is not mutable shared state. Bootstrap preserves and pins `comfyui-mcp-panel` at the reviewed direct-Hermes release `28d50b3` and disables Panel backend autospawn.
