...
- The MCP Panel is not mutable shared state. Bootstrap preserves and pins `comfyui-mcp-panel` v1.1.1 at the reviewed direct-Hermes release `c33cce2` and disables Panel backend autospawn.
